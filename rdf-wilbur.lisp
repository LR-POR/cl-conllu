...
(defun convert-to-rdf (sentences &key (text-fn #'sentence-text) (id-fn #'sentence-id) (corpusname "my-corpus") (namespace-string "http://www.example.org/") (stream *standard-output*) (rdf-format :ntriples))
  ...
  (let* ((wilbur:*nodes* (make-instance 'wilbur:dictionary))
	 (wilbur:*db* (make-instance 'wilbur:db))	
	 (namespaces `(("conll"  "http://br.ibm.com/conll/")
